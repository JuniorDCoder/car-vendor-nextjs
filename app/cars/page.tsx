...
export default function CarsPage() {
    ...
    const [filters, setFilters] = useState({
        ...
        maxPrice: '',
        fuelType: '',
        status: 'available', // Default to show available cars only
    });
    ...
    const loadCars = async () => {
        try {
            setLoading(true);
            const { cars: fetchedCars } = await carService.getCars(50); // Get up to 50 cars
            setCars(fetchedCars);
        ...
        return (
            <div className="pt-20 min-h-screen bg-gray-50 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="text-xl text-gray-600">Loading our premium collection...</p>
                </div>
            </div>
        );
    }
